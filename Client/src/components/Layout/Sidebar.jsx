...
function Sidebar() {
  ...
  return (
    <>
      ...
      <header className="md:hidden fixed top-0 left-0 right-0 h-14 bg-white/90 backdrop-blur border-b border-slate-200 z-40 flex items-center justify-between px-4">
        ...
        >
          ...
          <span className="block w-5">
            <span
              className={`block h-[2px] bg-slate-800 transition-transform ${
                mobileOpen ? "rotate-45 translate-y-[5px]" : ""
              }`}
            ></span>
            <span
              className={`block h-[2px] bg-slate-800 my-[5px] transition-opacity ${
      ...
      {/* Drawer panel */}
      <div
        className={`md:hidden fixed top-0 left-0 h-full w-50 max-w-[85vw] bg-white/95 backdrop-blur-md shadow-2xl ring-1 ring-slate-200 z-50 transform transition-transform duration-300 ${
